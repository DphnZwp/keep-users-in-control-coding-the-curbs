...
function renderSmartzones(data) {
  ...
  select.innerHTML += `
    ...
    <option selected disabled >Sorteer op naam</option>
    ...
    <button><a class="smartzones-button">Alle smartzones</a></button>
    `
  // Smartzone tables
